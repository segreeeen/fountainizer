		...
		if (singleFormatting == null) {
			...
			while (i < chars.length) {
				if (chars[i] == '_') {
					...
					currentFormat = new RichFormat(!currentFormat.isUnderline(),currentFormat.isBold(), currentFormat.isItalic());
					lastSplit = i+1;
					...
					currentFormat.setText(currentString);
					formattings.add(currentFormat);
					currentFormat = new RichFormat(currentFormat.isUnderline(),true, currentFormat.isItalic());
					lastSplit = i+1;
					...
					currentFormat.setText(currentString);
					formattings.add(currentFormat);
					currentFormat = new RichFormat(currentFormat.isUnderline(),false, currentFormat.isItalic());
					lastSplit = i+1;
