...
import at.hsol.fountainizer.pdf.pager.AbstractPager;
import at.hsol.fountainizer.pdf.pager.PagerUtils;
...
public class Paragraph implements Margin {
	...
	public Paragraph(FountainEmphasizedText fountainEmphasizedText) {
